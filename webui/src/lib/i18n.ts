...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'evolution.stopEvolution': 'Stop Evolution',
    'evolution.stopConfirm': 'Are you sure you want to stop this evolution? You can resume it later.',
    'evolution.stop': 'Stop',
    'evolution.mustStopFirst': 'Evolution is in progress. Please stop it first before deleting.',
    'evolution.resumeEvolution': 'Resume Evolution',
    'evolution.resumeConfirm': 'Resume this evolution? It will create a new evolution task.',
    ...
    'evolution.decisionAuto': 'Skill fails due to missing tool → auto-runs tool evolution first',
    ...
    'skills.sourcesDesc': 'Explore external skill sources that can be imported into the current Blockcell skill format',
    ...
    'skills.installExternalDesc': 'Enter an external skill URL. After download, Blockcell will stage it, enter self-evolution, and normalize it into the current Blockcell skill package.',
  ...
  zh: {
    ...
    'evolution.stopEvolution': '停止进化',
    'evolution.stopConfirm': '确定要停止此进化吗？稍后可以继续进化。',
    'evolution.stop': '停止',
    'evolution.mustStopFirst': '进化正在进行中，请先停止再删除。',
    'evolution.resumeEvolution': '继续进化',
    'evolution.resumeConfirm': '继续此进化？将创建一个新的进化任务。',
    'evolution.resume': '继续',
    'evolution.detail': '详情',
    ...
    'models.count': '{n} 个模型',
    'skills.sources': '技能来源',
    'skills.sourcesDesc': '探索可导入到当前 Blockcell skill 规范的外部技能来源',
    ...
    'skills.installExternalDesc': '输入外部技能地址，下载后会先进入 staging，再自动加入自进化流程，最终整理成当前 Blockcell skill 包格式。',
