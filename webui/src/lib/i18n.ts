...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'skills.installExternalDesc': 'Enter the URL of an OpenClaw-compatible skill. After downloading, it will enter the self-evolution pipeline automatically. Currently only .md skills are supported (script-based skills are not supported yet).',
  ...
  zh: {
    ...
    'skills.installExternalDesc': '输入 OpenClaw 兼容格式的技能地址，下载后将自动进入自进化流程。当前仅支持 .md 格式技能，暂不支持脚本类技能。',
